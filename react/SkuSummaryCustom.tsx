      ...
      >
        ...
        >
          <section
            ...
            aria-label={intl.formatMessage(storeMessages.shelfAriaLabel, {
...
ProductSummaryWrapper.schema = {
  title: adminMessages.productSummaryTitle.id,
  description: adminMessages.productSummaryDescription.id,
}
