...
import productSummary from './skuSummary.css'
...
function ProductImage({
  ...
  return (
    <div
      ...
      aria-label={intl.formatMessage(storeMessages.imageAriaLabel, {
...
ProductImage.schema = {
  title: adminMessages.productSummaryImageTitle.id,
  description: adminMessages.productSummaryImageDescription.id,
  type: 'object',
  properties: {
    showBadge: {
      type: 'boolean',
      title: adminMessages.productSummaryShowBadgeTitle.id,
      default: true,
      isLayout: true,
    },
    showCollections: {
      type: 'boolean',
      title: adminMessages.productSummaryShowCollectionsTitle.id,
      default: false,
      isLayout: true,
    },
    displayMode: {
      title: adminMessages.productSummaryDisplayModeTitle.id,
      type: 'string',
      enum: ['normal', 'inline'],
      default: 'normal',
      isLayout: true,
    ...
    hoverImageLabel: {
      title: adminMessages.productSummaryImageHoverImageLabelTitle.id,
      description:
        adminMessages.productSummaryImageHoverImageLabelDescription.id,
      type: 'string',
      default: '',
      isLayout: false,
    },
    hoverImage: {
      ...
      properties: {
        criteria: {
          title: adminMessages.productSummaryImageHoverImageCriteriaTitle.id,
          enum: ['index', 'label'],
        },
      },
      dependencies: {
          ...
          oneOf: [
            {
              properties: {
                ...
                index: {
                  title:
                    adminMessages.productSummaryImageHoverImageCriteriaIndex.id,
                  type: 'number',
                },
              },
            },
            {
              properties: {
                ...
                label: {
                  title:
                    adminMessages.productSummaryImageHoverImageCriteriaLabel.id,
                  type: 'string',
                },
                labelMatchCriteria: {
                  title:
                    adminMessages
                      .productSummaryImageHoverImageCriteriaMatchCriteria.id,
                  widget: {
                    'ui:widget': 'radio',
                  },
                  type: 'string',
    ...
    fetchpriority: {
      title: adminMessages.productSummaryImageFetchpriorityTitle.id,
      enum: ['high', 'low', 'auto', 'byPosition'],
      enumNames: [
        adminMessages.productSummaryImageFetchpriorityHigh.id,
        adminMessages.productSummaryImageFetchpriorityLow.id,
        adminMessages.productSummaryImageFetchpriorityAuto.id,
        adminMessages.productSummaryImageFetchpriorityByPosition.id,
      ],
      widget: {
        'ui:widget': 'radio',
      },
