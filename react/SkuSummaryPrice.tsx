...
import styles from './skuSummary.css'
...
ProductSummaryPrice.schema = {
  title: adminMessages.productSummaryPriceTitle.id,
  description: adminMessages.productSummaryPriceDescription.id,
  type: 'object',
  properties: {
    showListPrice: {
      type: 'boolean',
      title: adminMessages.productSummaryPriceShowListPriceTitle.id,
      default: true,
      isLayout: true,
    },
    showSellingPriceRange: {
      type: 'boolean',
      title: adminMessages.productSummaryPriceShowSellingPriceRangeTitle.id,
      default: false,
      isLayout: true,
    },
    showListPriceRange: {
      type: 'boolean',
      title: adminMessages.productSummaryPriceShowListPriceRangeTitle.id,
      default: false,
      isLayout: true,
    },
    showInstallments: {
      type: 'boolean',
      title: adminMessages.productSummaryPriceShowInstallmentsTitle.id,
      default: true,
      isLayout: true,
    },
    showDiscountValue: {
      type: 'boolean',
      title: adminMessages.productSummaryPriceShowDiscountValueTitle.id,
      default: false,
    },
    showLabels: {
      type: 'boolean',
      title: adminMessages.productSummaryPriceShowLabelsTitle.id,
      default: true,
      isLayout: true,
    },
    showBorders: {
      type: 'boolean',
      title: adminMessages.productSummaryPriceShowBordersTitle.id,
      default: false,
      isLayout: true,
    },
  },
