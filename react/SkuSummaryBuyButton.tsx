...
ProductSummaryBuyButton.schema = {
  title: adminMessages.productSummaryBuyButtonTitle.id,
  type: 'object',
  properties: {
    isOneClickBuy: {
      type: 'boolean',
      title: adminMessages.productSummaryIsOneClickBuyTitle.id,
      default: false,
      isLayout: true,
    },
    displayBuyButton: {
      title: adminMessages.productSummaryDisplayBuyButtonTitle.id,
      type: 'string',
      enum: getDisplayButtonValues(),
      enumNames: [
        adminMessages.productSummaryDisplayBuyButtonOptionAlways.id,
        adminMessages.productSummaryDisplayBuyButtonOptionHover.id,
        adminMessages.productSummaryDisplayBuyButtonOptionNone.id,
      ],
